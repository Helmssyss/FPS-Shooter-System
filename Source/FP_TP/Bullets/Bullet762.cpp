...
void ABullet762::BeginPlay() {
	Super::BeginPlay();
	bulletSphere->OnComponentHit.AddDynamic(this, &ABullet762::BulletHit);
}
...
void ABullet762::BulletHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit) {
	BulletImpactParticle(OtherComp, Hit);
	DestroyBullet();
}

void ABullet762::BulletImpactParticle(UPrimitiveComponent* OtherComp, const FHitResult& Hit) {
